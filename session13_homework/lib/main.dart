          ...
          children: [
            ...
            Row(
              ...
              children: [
                Column(
                  children: [
                    Container(color: Color(0xffA5D6A7), height: 50, width: 120),
                    Container(height: 10, width: 120, color: Color(0xffE9F8EA)),
                    Container(color: Color(0xffA5D6A7), height: 50, width: 120),
                  ],
                ),
                Row(
                  children: [
                    ...
                    Container(width: 10, height: 110, color: Color(0xffFFF3DF)),
                    Container(
                      height: 110,
                      width: 110,
                      color: Color(0xffFFCC80),
            ...
            Row(
              ...
              children: [
                ...
                Column(
                  children: [
                    Container(height: 45, width: 90, color: Color(0xffCF93D9)),
                    Container(height: 10, width: 90, color: Color(0xffDDB1E6)),
                    Container(height: 45, width: 90, color: Color(0xffCF93D9)),
                  ],
                ),
                Container(width: 10, height: 100, color: Color(0xffF3E5F6)),
